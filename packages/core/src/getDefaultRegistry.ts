...
import { generateFields as fields } from './components/fields/index.ts';
import { generateTemplates as templates } from './components/templates/index.ts';
import { generateWidgets as widgets } from './components/widgets/index.ts';
