...
const PACKAGES = {
  '@rjsf/core': {
    ...
    own: '24 kB',
    canaries: [
      { label: 'Form', import: 'Form', limit: '24 kB' },
      { label: 'createForm', import: '{ createForm }', limit: '5 kB' },
    ],
  },
  '@rjsf/utils': {
    installed: '34 kB',
...
module.exports = released.flatMap(({ dir, pkg }) => {
  ...
  const subpaths = Object.entries(pkg.exports).filter(([key]) => key !== '.' && !NODE_ONLY_SUBPATHS.includes(key));
